...
var KTDualListbox = function() {
  ...
  var initDualListbox = function() {
    ...
    listBoxes.each(function() {
      var $this = $(this);
      // get titles
      var availableTitle = ($this.attr('data-available-title') != null) ? $this.attr('data-available-title') : 'Available contacts';
      var selectedTitle = ($this.attr('data-selected-title') != null) ? $this.attr('data-selected-title') : 'Selected contacts';
      ...
      var dualListBox = new DualListbox($this.get(0), {
        addEvent: function(value) {
            $('#contacts_list').append('<input id="contact-'+value+'" type="hidden" name="contacts[]" value="'+ value +'">')
          // console.log(value);
        },
        removeEvent: function(value) {
            $('#contacts_list').remove('input#contact-'+ value)
          // console.log(value);
        },
